...
User.create!(email: "clown2@clowns.com", password: "342516", password_confirmation: "342516", middleName: "a", lastName: "co", firstName: "Sh") 
Todolist.create!(user_id: 1, name: "Death Note")
Todolist.create!(user_id: 1, name: "Death Note 2")
Todolist.create!(user_id: 2, name: "Death Note 3")
Todolist.create!(user_id: 2, name: "Death Note 4")
...
Todo.create!(title: "Captain Ivy", todoList_id: 3)
Todo.create!(title: "Captain Ivy", todoList_id: 3)
Todo.create!(title: "Captain Ivy", todoList_id: 3)
Todo.create!(title: "Captain Ivy", todoList_id: 3)
Todo.create!(title: "Captain Ivy", todoList_id: 3)
